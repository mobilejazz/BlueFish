...
@protocol MJBTNotificationDelegate <NSObject>

- (void)didNotifiedValue:(NSData *)value forCharacteristicID:(NSString *)characteristicID;

@end

@interface MJBTPeripheral : NSObject <CBPeripheralDelegate>
...
@property (nonatomic, weak, readwrite) id <MJBTNotificationDelegate> notificationDelegate;
